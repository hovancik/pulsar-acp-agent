...
- Added a "Permissions: Ask / Allow all" footer toggle to auto-approve `allow_once` ACP permission prompts for the current session. The flag resets on new session or restart.
